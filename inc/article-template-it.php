...
it_head(['title' => $TITLE . ' — AURALIS', 'desc' => $DESC, 'url' => $URL, 'og_type' => 'article', 'alt_bg' => $ALT_BG, 'alt_ro' => $_alts['ro'] ?? '', 'alt_el' => $_alts['el'] ?? '', 'alt_en' => $_alts['en'] ?? '', 'alt_es' => $_alts['es'] ?? '', 'jsonld' => $JSONLD]);
