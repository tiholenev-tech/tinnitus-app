...
> ⛔ **№0 — ЧЕТИ ПРЪВ, ПРЕДИ ВСИЧКО ОСТАНАЛО:**
> **[`docs/AURALIS_STRATEGIA_FINAL_20260605.md`](AURALIS_STRATEGIA_FINAL_20260605.md)**
> — водещият стратегически документ (бизнес/маркетинг/съдържание/езици/цена/
> дистрибуция). Има приоритет пред долните „библии" по тези теми — те са
> ОСТАРЕЛИ по дистрибуция, цена и езици. (Същото е заковано и в root `CLAUDE.md`.)
