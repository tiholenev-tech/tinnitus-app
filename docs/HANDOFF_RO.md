...
> **PUSH-нато** на origin.
>
> ✅ **ПРЕВОДЪТ Е 100% ЗАВЪРШЕН.** 1544/1544 листа. `i18n_validate.py ro` = **0 проблема**
> (74 идентични с bg са легитимни: кодове, плейсхолдъри, автоними, английски цитат-заглавия).
> `check_claims.py ro` = **0 BLOCK**. Остава САМО регистрацията (стъпки долу).
